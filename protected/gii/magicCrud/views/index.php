...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row sticky">
		<?php echo $form->labelEx($model,'baseAdminControllerClass'); ?>
		<?php echo $form->textField($model,'baseAdminControllerClass',array('size'=>65)); ?>
		<div class="tooltip">
			This is the class that the new CRUD controller class will extend from.
			Please make sure the class exists and can be autoloaded.
		</div>
		<?php echo $form->error($model,'baseAdminControllerClass'); ?>
	</div>
