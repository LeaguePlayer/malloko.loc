<?php
/**
 * Миграция m130811_072635_jobs
 *
 * @property string $prefix
 */
 
class m130811_072635_jobs extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{jobs}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{jobs}}', array(
			...
			'name' => "varchar(256) NOT NULL COMMENT 'Название должности'",
