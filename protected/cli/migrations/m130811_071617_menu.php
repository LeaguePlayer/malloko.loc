<?php
/**
 * Миграция m130811_071617_menu
 *
 * @property string $prefix
 */
 
class m130811_071617_menu extends CDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{menu}}', array(
			...
			'name' => "varchar(256) NOT NULL COMMENT 'Название меню'",
			'image' => "varchar(256) COMMENT 'Превью'",
			'html_content' => "text COMMENT 'Состав меню'",
