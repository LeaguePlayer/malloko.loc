<?php
/**
 * Миграция m130812_024104_interiors
 *
 * @property string $prefix
 */
 
class m130812_024104_interiors extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{interiors}}');
